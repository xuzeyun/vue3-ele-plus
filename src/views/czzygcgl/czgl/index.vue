  ...
  <div class="g-flex-col">
    <div class="g-query">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        <el-form-item label="残渣类型">
          <el-select v-model="formInline.czlx" placeholder="请选择">
        ...
        <el-form-item label="存储仓库">
          <el-select v-model="formInline.ccck" placeholder="请选择">
    ...
    <div class="g-btns">
      <el-button type="primary" :icon="EditPen" @click="addHandle">登记</el-button>
      <div class="g-info">
        <dl>
          <dt>仓库总数：</dt>
          <dd>5</dd>
    ...
    <div class="g-table">
      <div class="g-table-self">
        <el-table :data="tableData" ref="tableDataRef" border>
          ...
          <el-table-column prop="ccck" label="存储仓库" show-overflow-tooltip />
          <el-table-column prop="bh" label="编号" show-overflow-tooltip />
          <el-table-column prop="czlx" label="残渣类型" show-overflow-tooltip />
          <el-table-column prop="zl" label="重量（吨）" show-overflow-tooltip />
          <el-table-column prop="djsj" label="登记时间" show-overflow-tooltip />
...
import { Edit, EditPen, Download, Search, Refresh, Delete } from "@element-plus/icons-vue";
